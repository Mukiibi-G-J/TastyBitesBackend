...
exports.GetVandorByID = exports.GetVanndors = exports.CreateVandor = exports.FindVendor = void 0;
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                req.body, name = _a.name, address = _a.address, pincode = _a.pincode, foodType = _a.foodType, email = _a.email, password = _a.password, ownerName = _a.ownerName, phone = _a.phone;
                return [4 /*yield*/, (0, exports.FindVendor)('', email)];
            case 1:
                existingVandor = _b.sent();
                if (existingVandor != null) {
                    return [2 /*return*/, res.json({ message: 'A vendor exist with thi email' })];
                }
